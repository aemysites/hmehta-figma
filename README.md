...
## Environments
- Preview: https://main--hmehta-figma--aemysites.aem.page/
- Live: https://main--hmehta-figma--aemysites.aem.live/
...
1. Open the `hmehta-figma` directory in your favorite IDE and start coding :)
